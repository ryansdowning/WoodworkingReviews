...
import { WWReviewsSidebar } from "./WWReviewsSidebar";
...
export interface WWReviewsAppShellProps extends AppShellProps {
  pt?: number;
  pl?: number;
  pr?: number;
  pb?: number;
...
export function WWReviewsAppShell({ children, pt, pl, pr, pb, title, ...others }: WWReviewsAppShellProps) {
  ...
  return (
    <OverlayContext.Provider value={[overlay, setOverlay]}>
      <ModalsProvider>
        ...
        >
          <Head>
            <title>{title ? title : "WWReviews Dashboard"}</title>
          </Head>
